...
class TranslationSurfaceGenerators:
    ...
    def mcmullen_genus2_prototype(w, h, t, e, rel=0, base_ring=None):
        ...
        if rel:
            ...
            s.add_polygon(
                polygons(vertices=[(0, 0), (l, 0), (l, l), (0, l)], ring=K), label=0
            )
            s.add_polygon(
                polygons(
    ...
    def mcmullen_L(l1, l2, l3, l4):
        ...
        s = Surface_dict(base_ring=field)
        s.add_polygon(
            polygons((l3, 0), (0, l2), (-l3, 0), (0, -l2), ring=field), label=0
        )
        s.add_polygon(
            polygons((l3, 0), (0, l1), (-l3, 0), (0, -l1), ring=field), label=1
        )
        s.add_polygon(
            polygons((l4, 0), (0, l2), (-l4, 0), (0, -l2), ring=field), label=2
        )
        s.change_edge_gluing(0, 0, 1, 2)
