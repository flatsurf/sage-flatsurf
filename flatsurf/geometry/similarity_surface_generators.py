...
class TranslationSurfaceGenerators:
    ...
    @staticmethod
    def lanneau_nguyen_genus3_prototype(w, h, t, e, rel=0, base_ring=None):
        r"""
        Lanneau--Ngyuen prototypes in the stratum H(4).

        These prototype appear in Lanneau--Nguyen "Teichmüller curves generated by Weierstrass Prym eigenforms in genus 3 and genus 4" (2014).
    ...
    @staticmethod
    def lanneau_nguyen_genus4_prototype(w, h, t, e, rel=0, base_ring=None):
        r"""
        Lanneau--Ngyuen prototypes in the stratum H(6).

        These prototype appear in Lanneau—Nguyen "Weierstrass Prym Eigenforms in Genus 4" (2020).
