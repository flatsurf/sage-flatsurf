...
Let us first construct a Veech surface::
...
class GL2ROrbitClosure:
    ...
    def flow_decomposition_kontsevich_zorich_cocycle(self, decomposition):
        r"""
        Base change from the homology of ``decomposition``.
        ...
        """
        # NOTE: to deal with homology we only need the saddle connection appearing
        # in the perimeter of each component.
        components = [c for c in decomposition.components()]
        sc_pos = []
        sc_comp = {}
        sc_index = {}
        ...
        assert proj.nrows() == self.proj.nrows(), self.u
