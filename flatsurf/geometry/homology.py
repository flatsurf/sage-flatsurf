...
class SimplicialHomologyClass(Element):
    ...
    def chain(self):
        r"""
        Return a lift of this element to the :meth:`SimplicialHomology.chain_module`.
    ...
    @cached_method
    def simplex_coefficients(self):
        r"""
        Return pairs (coefficient, simplex) such that this homology class can
        be written as the chain Σ coefficient · simplex.
        ...
        EXAMPLES::
            ...
            sage: H = SimplicialHomology(T)
            sage: a, b = H.gens()
            sage: (a - b).simplex_coefficients()
            ((1, (0, 1)), (-1, (0, 0)))

        """
        return tuple((self._chain[s], s) for s in self._chain.support())

    @cached_method
    def holonomy(self):
        r"""
        Return a holonomy vector given by summing the terms with multiplicity
        that describe a representation of this homology class as a chain.

        This only works if the homology is generated by edges, i.e., when this
        is a homology class in degree 1.
        ...
        TESTS::
            ...
            Traceback (most recent call last):
            ...
            NotImplementedError: cannot form holonomy in this degree
