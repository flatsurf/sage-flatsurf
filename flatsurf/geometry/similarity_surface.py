...
class SimilaritySurface(SageObject):
    ...
    def copy(
        ...
        if relabel:
            ...
            warn(
                "copy(relabel=True) is deprecated and will be removed in a future version of sage-flatsurf. Use relabel() instead."
            )
    ...
    def subdivide_polygon(self, p, v1, v2, test=False, new_label=None):
        ...
        if new_label is None:
            ...
            warnings.warn(
                "subdivide_polygon() without specifying a label is deprecated and will be removed from a future version of sage-flatsurf. Explicitly specify a label instead, e.g., use subdivid_polygon(label=surface.num_polygons())."
            )
    ...
    def reposition_polygons(self, in_place=False, relabel=False):
        ...
        if relabel:
            ...
            warnings.warn(
                "reposition_polygons(relabel=True) is deprecated and will be removed from a future version of sage-flatsurf. Do not specify relabel at all instead and use the relabel() method explicitly if you need a relabeling to happen."
            )
    ...
    def triangulate(self, in_place=False, label=None, relabel=False):
        ...
        if relabel:
            ...
            warnings.warn(
                "Calling triangulate() with relabel=True is deprecated and will be removed in a future version of sage-flatsurf. Triangulate without relabeling and then call relabel() instead."
            )
                ...
                for i in range(n):
                    ...
                    if wedge_product(e1, e2) != 0:
                        ...
                        if wedge_product(e1 + e2, e3) != 0:
                            ...
                            s.subdivide_polygon(
                                label, i, (i + 2) % n, new_label=new_label
                            )
                            break
            return s
    ...
    def delaunay_triangulation(
        ...
        if relabel:
            ...
            warnings.warn(
                "Running delaunay_triangulation with relabel=True is deprecated and will be an error in future versions of sage-flatsurf. Do not set relabel explicitly instead."
            )
