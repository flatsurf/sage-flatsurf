...
def surface_to_xml_string(s, complain=True):
    ...
    warnings.warn(
        "surface_to_xml_string() is deprecated and will be removed in a future version of sage-flatsurf"
    )
...
def surface_to_xml_file(s, filename, complain=True):
    ...
    warnings.warn(
        "surface_to_xml_file() is deprecated and will be removed in a future version of sage-flatsurf"
    )
...
def surface_from_xml_string(string):
    ...
    warnings.warn(
        "surface_from_xml_string() is deprecated and will be removed in a future version of sage-flatsurf"
    )
...
def surface_from_xml_file(filename):
    ...
    warnings.warn(
        "surface_from_xml_file() is deprecated and will be removed in a future version of sage-flatsurf"
    )
