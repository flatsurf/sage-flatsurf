...
class LazyTriangulatedSurface(Surface):
    ...
    def __init__(self, similarity_surface, relabel=True):
        if relabel:
            ...
            warnings.warn(
                "Creating a LazyTriangulatedSurface with relabel=True is deprecated and will be removed in a future version of sage-flatsurf."
            )
...
class LazyDelaunayTriangulatedSurface(Surface):
    ...
    def __init__(self, similarity_surface, direction=None, relabel=True):
        ...
        if relabel:
            ...
            warnings.warn(
                "Creating a LazyDelaunayTriangulatedSurface with relabel=True is deprecated and will be removed in a future version of sage-flatsurf."
            )
...
class LazyDelaunaySurface(LazyDelaunayTriangulatedSurface):
    ...
    def __init__(self, similarity_surface, direction=None, relabel=True):
        ...
        if relabel:
            ...
            warnings.warn(
                "Creating a LazyDelaunaySurface with relabel=True is deprecated and will be removed in a future version of sage-flatsurf."
            )
